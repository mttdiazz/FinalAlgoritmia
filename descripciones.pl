descripcion("Minecraft","Minecraft is a game made up of blocks, creatures, and community.
                \nBlocks can be used to reshape the world or build fantastical creations. 
                \nExperience epic adventures solo or with friends, there's no wrong way to play.").
descripcion("Minecraft","https://www.minecraft.net/en-us").

descripcion("Age of Empires","Age of Empires: Definitive Edition is the new, lovingly remastered 
                            \nversion of the legendary real-time strategy game straight from the pages of history! 
                            \nRelive the most glorious battles of history with all-new graphics, music, sound, and more.").
...
descripcion("Fall Guys","Fall Guys is a free, cross-platform massively multiplayer party royale game. 
                        \nClumsily compete in absurd obstacle courses with friends or build your very own 
                        \nchaotic course to share with the community.").
descripcion("Fall Guys","https://store.epicgames.com/en-US/p/fall-guys").

descripcion("Fortnite","Create, play, and battle with friends in Fortnite. 
                        ...
                        \nDrop in."). 
descripcion("Fortnite","https://store.epicgames.com/en-US/p/fortnite").

descripcion("Valorant","Blend your style and experience on a global, competitive stage. 
                        \nTake on foes across Competitive and Unranked modes as well as 
...
descripcion("League of Legends","League of Legends is a team-based strategy game 
                                \nwhere two teams of five powerful champions face off to destroy the other's base. 
...
descripcion("Blackjack","El blackjack es un juego de cartas propio de los casinos.
                        \nConsiste en sumar un valor lo más próximo a 21 pero sin pasarse.").
descripcion("Blackjack","https://es.wikipedia.org/wiki/Blackjack").
...
descripcion("Ajedrez","El ajedrez es un juego de tablero entre dos contrincantes 
                        ...
                        \ndque se desplazan sobre un tablero capturando piezas del jugador contrario, 
...
descripcion("Tuttifrutti","El tutti frutti es un juego de lápiz y papel cuyo objetivo es escribir, 
                        \ndurante un tiempo limitado, una serie de palabras pertenecientes a categorías 
                        \npredefinidas por los jugadores que comiencen con la misma letra").
descripcion("Tuttifrutti","https://es.wikipedia.org/wiki/Tutti_frutti_(juego)").

descripcion("Dragon Ball Cards","DRAGON BALL SUPER CARD GAME es un juego de cartas 
...
descripcion("God of War","Living as a man outside the shadow of the gods, Kratos must adapt 
                        \nto unfamiliar lands, unexpected threats, and a second chance at being a father. 
                        \nTogether with his son Atreus, the pair will venture into the brutal Norse wilds 
...
descripcion("Legend of Zelda","You'll decide your own path through the sprawling landscapes 
                            \nof Hyrule and the mysterious islands floating in the vast skies above. 
                            \nCan you harness the power of Link's new abilities to fight back against 
                            \nthe malevolent forces that threaten the kingdom?").
descripcion("Legend of Zelda","https://zelda.nintendo.com/").

descripcion("Ace Attorney","Fourteen thrilling cases across three titles!
                            \nHelp a fledgling attorney save his innocent clients
                            \n by finding out the truth behind murder cases.").
descripcion("Ace Attorney", "https://www.ace-attorney.com/").

descripcion("Solitario","Juego de cartas de un jugador que consiste en colocar las cartas en un tablero 
                        \ny ordenarlas según unas reglas específicas.").
descripcion("Solitario", "https://es.wikipedia.org/wiki/Solitario").

descripcion("Yu Gi Oh","Yu-Gi-Oh! es un emocionante universo basado en un juego de cartas 
                        \nque se juega con Monstruos, Magias y Trampas.").
descripcion("Yu Gi Oh", "https://www.konami.com/yugioh/masterduel/us/es/").

descripcion("Pokemon","Experience the true joy of the Pokemon series,
                        \nbattling against wild Pokémon in order to catch them,
...
descripcion("7 days","7 Days is a mobile visual novel where you can choose your path with your actions.
                    \nYou play as Kirell, a girl stuck in a world between life and death. 
                    \nAfter talking to Charon, you have the task to follow a compass that only works when someone dies.").
descripcion("7 days", "https://7days-choose-your-story.fandom.com/wiki/7Days_Decide_your_story_Wiki").

descripcion("Underworld office","Underworld Office is a chat style interactive story game.
                                \nFollow Eugene, a young boy who accidentally finds himself in
                                \nthe world of ghosts and must figure out how to survive.").
descripcion("Underworld office", "https://play.google.com/store/apps/details?id=com.buffstudio.uwofficefree&hl=es_CO").

descripcion("No man's sky", "Be the first to land on beautiful, unknown planets teeming with life. 
                            \nSurvive hazardous environments, where alien civilizations seek their 
                            \nfortune and outlaws take it by force.").
descripcion("No man's sky", "https://www.nomanssky.com/").

descripcion("60 seconds","As Ted, a responsible citizen and a family man, you are faced with a slight 
                        \ndisturbance to your happy, suburban lifestyle. THE NUCLEAR APOCALYPSE.
                        \nReaching the fallout shelter in time and alive is only the beginning.
                        \nEach survival story will be different, with every day surprising you 
                        \nwith unexpected events. Will all of these stories end well? It's up to you.").
descripcion("60 seconds","https://store.steampowered.com/app/368360/60_Seconds/https://store.steampowered.com/app/368360/60_Seconds/").

descripcion("Euro Truck Simulator","Euro Truck Simulator 2 gives you the chance to become a real truck driver 
                                    \nfrom the comfort of your home! Featuring licensed trucks with 
                                    \ncountless customization options and advanced driving physics, 
                                    \nthe game delivers an unparalleled driving experience.").
descripcion("Euro Truck Simulator", "https://eurotrucksimulator2.com/").

descripcion("Goat Simulator", "Goat Simulator 3 is a brand new third-person sandbox adventure game 
                                \nin which you get to become the literal GOAT. You'll need to headbutt, 
                                \nlick and triple-jump your way across the giant island of San Angora,
                                \nthis time with all new areas, challenges, and events to discover.").
descripcion("Goat Simulator", "https://www.goatsimulator3.com/es/").

descripcion("Stardew Valley","You've inherited your grandfather's old farm plot in Stardew Valley. 
...
descripcion("Just Dance","UNLEASH YOUR INNER DANCER! All it takes to turn any room into a crazy dancefloor 
                        \nis an internet-connected screen and a smartphone to use as a controller!").
descripcion("Just Dance","https://justdancenow.com/").

descripcion("Fight night Champion","Fight Night Champion takes the boxing experience much further 
                                    \nand provides us with something never seen before. Immerse yourself in a world of 
                                    \nbrutality, uncertainty, betrayal and redemption. Survive the tough road to redemption 
                                    \nwith Fight Night Champion.").
descripcion("Fight night Champion","https://www.ea.com/es-es/games/fight-night/fight-night-champion").

descripcion("NBA 2k24","Grab your friends and enjoy the ultimate basketball experience in NBA 2K24.
                        \nCompete with or against players around the world in dynamic co-op matches, 
                        \nthrilling online tournaments, or casual pick-up games.").
descripcion("NBA 2k24","https://nba.2k.com/2k24/").

descripcion("Dream League Soccer 2","Dream League Soccer 2024 puts you in the heart of the soccer action with a 
                                    \nfresh look and brand new features! Rise through 8 divisions whilst enjoying 
                                    \nfull 3D motion-captured player moves, immersive in-game commentary, 
                                    \nteam customisations and much more. The beautiful game has never been so good!").
descripcion("Dream League Soccer 2","https://play.google.com/store/apps/details?id=com.firsttouchgames.dls7&hl=en&gl=US").



descripcion("Sonic", "Adventure through the mystical Northstar Islands in this all-new take on classic 2D 
                    \nSonic high-speed action platforming. Navigate gorgeous, never-before-seen environments 
                    \nsolo or with up to 3 other players and stop your adversaries from converting the islands' 
                    \ngiant animals into Badniks before it's too late!").
descripcion("Sonic", "https://www.sonicthehedgehog.com/").

descripcion("Crash Bandicoot", "CRASH BANDICOOT, YOUR FAVORITE MARSUPIAL, IS BACK ENHANCED, ENTHRALLED AND READY TO DANCE!
                                \nEXPERIENCE THE EPIC ADVENTURES AND CHALLENGES OF THE THREE GAMES THAT STARTED IT ALL. ").
descripcion("Crash Bandicoot", "https://www.crashbandicoot.com/es/hub").


descripcion("Mario Bros","Meet Mario, the mustachioed hero of the Mushroom Kingdom. You may know him as a plumber, 
                        \nbut he's also a race car racer, a sports star, a caped hero and more! Using his incredible 
...
descripcion("Pumpkin panic","Pumpkin Panic is a thrilling survival game in which players 
                            \ntake care of a garden while trying to survive hostile creatures. 
                            \nCan you escape this spooky place?").
descripcion("Pumpkin panic","https://pumpkinpanic.com").
